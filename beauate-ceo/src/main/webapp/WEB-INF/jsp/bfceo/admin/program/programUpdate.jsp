...
<body>
		...
		<div class="container">
			...
			<div class="contents">
				...
				<div class="T_btnLayer fr">
					<a href="javascript:void(0);" onclick="javascript:fn_updateProgramProc();"><button type="button" class="blueBtn L">수정</button></a>
					<a href="javascript:void(0);" onclick="javascript:fn_programDetail();"><button type="button" class="blueBtn L">취소</button></a>
				</div>
			</div>
		</div>
		<!--container End-->
	...
	//취소 - 상세정보로 돌아감
	var fn_programDetail = function() {
		var frm = document.resultVO;
		frm.action = "<c:url value='${basePath}/program/z/m/selectProgramDetal.do'/>";
		frm.submit();
	};
	</script>
</body>
