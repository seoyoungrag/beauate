...
<form:form modelAttribute="menuVO" id="detailForm" name="detailForm" method="post" action="${basePath}/menu/z/n/insertMenuProc.do">
<!-- 정렬값 비교 때문에 이전값을 세팅해둠 -->
<form:hidden path="menuId"/>
<form:hidden path="upperMenuId"/>
<!-- 상위 메뉴 레벨 -->
<form:hidden path="menuLv" />
<input type="hidden" name ="preMenuLup" value="${menuVO.menuSort }" />
			...
			<tr>
				...
				<td>
					<div class="commonSearch_wrap">
						...
						<form:input path="menuNm" id="menuNm" name="menuNm" cssStyle="width: 193px" onfocus="checker(this, 30 , 'nbytes_menuName');" onblur="stopchecker();"/>
					</div>       
				</td>
				<th>메뉴구분</th>
				<td>
			...
			<tr>
				...
				<td colspan="4">
					<div class="commonSearch_wrap">
						...
						<form:input path="menuCn" cssStyle="width: 553px" onfocus="checker(this, 200 , 'nbytes_menuDes');" onblur="stopchecker();"/>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td colspan="4">
					...
					<div class="commonSearch_wrap align40_Left">
						<label class="blind" for=" ">d</label> 
						<form:input path="extrlUrl" id="otUrl" name="otUrl" value="http://" style="width: 250px" disabled="true" onfocus="checker(this, 200 , 'nbytes_otUrl');" onblur="stopchecker();"/>                                            
					</div>      
				</td>
			</tr>
			<tr> 
				<td colspan="4">
					...
					<div class="commonSearch_wrap align3_Left">
						...
						<label class="blind" for=" "></label> 
	                  	<form:input path="prgrMng.prgrNm" id="pgmName" cssStyle="width: 250px;" readonly="true" />
					</div>
