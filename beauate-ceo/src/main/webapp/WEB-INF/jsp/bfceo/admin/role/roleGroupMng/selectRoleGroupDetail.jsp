	...
	<div class="container">
		...
		<div class="contents">
			<p class="contentTitle">권한관리</p>
				...
				<form:form modelAttribute="roleVO" method="post" id="detailForm">
						...
						<table class="table">
							...
							<tbody class="line">
								<tr>
									...
									<td><c:out value="${roleVO.athrCd}"/></td>
								</tr>
								<tr>
									<th><c:out value="권한그룹명"/></th>
									<td><c:out value="${roleVO.athrNm}"/></td>
								</tr>
								<tr>
									<th><c:out value="권한분류"/></th>
									<td><c:out value="${roleVO.athrCl}"/></td>
								</tr>
								<tr>
									<th><c:out value="권한설명"/></th>
									<td><c:out value="${roleVO.athrCn}"/></td>
								</tr>
							</tbody>
						</table>
					</div>
